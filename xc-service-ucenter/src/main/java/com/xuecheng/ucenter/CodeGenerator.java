...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String packageName = "com.xuecheng.ucenter";   // 生成的包名
        boolean serviceNameStartWithI = false;//user -> UserService, 设置成true: user -> IUserService
        String dir = "D:\\IdeaProjects\\xcEduService\\xc-service-ucenter\\src\\main\\java";
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String dir, String... tableNames ) {
        ...
        String dbUrl = "jdbc:mysql://127.0.0.1:3306/xc_user?serverTimezone=CTT&useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true";
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setDbType(DbType.MYSQL)
                .setUrl(dbUrl)
                .setUsername("root")
